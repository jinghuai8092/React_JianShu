        ...
        return (
            <WriterWrapper>
                <div className='title'>
                    ...
                    <span className='WriterChange' onClick={() => this.props.handChangePage(page, totalPage,this.spinIcon)}><i ref={(icon)=>{this.spinIcon=icon}} className='iconfont change'>&#xe606;</i>Change</span>
                </div>
